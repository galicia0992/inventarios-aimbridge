...
// node_modules/burger-menu/lib/es/index.js
...
var identity = (v2) => v2;
var createAttractor = (alterDisplacement = identity) => (constant, origin, v2) => {
...
var SubscriptionManager = (
  ...
  function() {
    ...
    SubscriptionManager2.prototype.notify = function(a3, b3, c3) {
...
function compareMin(a3, b3) {
  return a3.layout.min - b3.layout.min;
}
...
var calcBezier2 = (t2, a1, a22) => (((1 - 3 * a22 + 3 * a1) * t2 + (3 * a22 - 6 * a1)) * t2 + 3 * a1) * t2;
var subdivisionPrecision2 = 1e-7;
var subdivisionMaxIterations2 = 12;
function binarySubdivide2(x2, lowerBound, upperBound, mX1, mX2) {
  let currentX;
  let currentT;
  let i2 = 0;
  do {
    currentT = lowerBound + (upperBound - lowerBound) / 2;
    currentX = calcBezier2(currentT, mX1, mX2) - x2;
    if (currentX > 0) {
      upperBound = currentT;
    } else {
      lowerBound = currentT;
...
function p(e2, t2) {
  var n2 = {};
  for (var l2 in e2)
    Object.prototype.hasOwnProperty.call(e2, l2) && t2.indexOf(l2) < 0 && (n2[l2] = e2[l2]);
  if (null != e2 && "function" == typeof Object.getOwnPropertySymbols) {
    var s2 = 0;
    for (l2 = Object.getOwnPropertySymbols(e2); s2 < l2.length; s2++)
      t2.indexOf(l2[s2]) < 0 && Object.prototype.propertyIsEnumerable.call(e2, l2[s2]) && (n2[l2[s2]] = e2[l2[s2]]);
  }
  return n2;
}
function v(n2) {
  return function(l2) {
    const { style: s2, className: a3, rotate: i2 } = l2, o2 = p(l2, ["style", "className", "rotate"]), r2 = (0, import_classnames.default)("icon icon-default", a3), c3 = {};
    return Number.isSafeInteger(i2) && (c3.transform = `rotate(${i2}deg)`), Object.assign(c3, s2), import_react50.default.createElement("span", Object.assign({ role: "img", className: r2, style: c3 }, o2), (0, import_react50.createElement)(n2));
  };
}
var y = v(function(t2) {
  return import_react50.default.createElement("svg", Object.assign({ viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em" }, t2), import_react50.default.createElement("path", { d: "M904.533333 311.466667c-17.066667-17.066667-42.666667-17.066667-59.733333 0L512 644.266667 179.2 311.466667c-17.066667-17.066667-42.666667-17.066667-59.733333 0-17.066667 17.066667-17.066667 42.666667 0 59.733333l362.666666 362.666667c8.533333 8.533333 19.2 12.8 29.866667 12.8s21.333333-4.266667 29.866667-12.8l362.666666-362.666667c17.066667-17.066667 17.066667-42.666667 0-59.733333z", "p-id": "4865" }));
});
var h = (t2) => {
  const { children: a3, isVisible: i2 } = t2, [o2, r2] = (0, import_react50.useState)(0), c3 = (0, import_react50.useCallback)((e2) => {
    if (e2) {
      const t3 = e2.scrollHeight;
      t3 && o2 !== t3 && r2(t3);
    }
  }, [o2]), m3 = (0, import_react50.useMemo)(() => `${Math.random()}:${Date.now()}`, []), p2 = import_react50.default.createElement(motion.div, { className: "sub-menu", ref: c3, key: m3, transition: { duration: 0.3, ease: "easeInOut" }, initial: "collapsed", animate: i2 ? "open" : "collapsed", exit: "collapsed", variants: { open: { height: o2 || "auto", opacity: 1, overflow: "auto", transitionEnd: { height: "auto" } }, collapsed: { height: 0, opacity: 0, overflow: "hidden" } } }, a3 || "");
  return import_react50.default.createElement(AnimatePresence, null, i2 && p2);
};
var g = (t2) => {
  const { title: l2, icon: s2, children: o2 } = t2, r2 = p(t2, ["title", "icon", "children"]), c3 = (e2) => {
    var t3;
    return e2.props.itemKey === r2.selectedKey || !!(null === (t3 = e2.props.children) || void 0 === t3 ? void 0 : t3.length) && e2.props.children.some(c3);
  }, [m3, d] = (0, import_react50.useState)({ isVisible: import_react50.Children.toArray(o2).some(c3), rotate: 0 }), { isVisible: u, rotate: v2 } = m3;
  return import_react50.default.createElement("div", { className: "sub-menu-wrap" }, import_react50.default.createElement("div", { className: "sub-item", onClick: () => {
    const e2 = m3.isVisible ? 0 : 180;
    d(Object.assign(Object.assign({}, m3), { isVisible: !m3.isVisible, rotate: e2 }));
  } }, import_react50.default.createElement("span", { className: "title" }, l2), import_react50.default.createElement("span", { className: "arrow" }, s2 || import_react50.default.createElement(y, { className: "arrow", rotate: v2 }))), import_react50.default.createElement(h, { isVisible: u }, import_react50.Children.map(o2, (e2) => (0, import_react50.cloneElement)(e2, Object.assign(Object.assign({}, r2), { level: r2.level + 1 })))));
};
g.defaultProps = {};
var b2 = { overlay: () => ({ position: "fixed", zIndex: 1e3, width: "100%", height: "100%", top: 0, bottom: 0, left: 0, right: 0, background: "rgba(0, 0, 0, 0.3)" }), menuWrap: (e2) => ({ position: "fixed", zIndex: 1100, width: e2, height: "100%" }) };
var f = { slide: { right: { start: { x: "0" }, end: { x: "100%" }, style: { right: 0 } }, left: { start: { x: "100%" }, end: { x: "0" }, style: { right: "100%" } } }, fallDown: { left: { start: { y: "100%" }, end: { y: "0" }, style: { left: 0, top: "-100%" } }, right: { start: { y: "100%" }, end: { y: "0" }, style: { right: 0, top: "-100%" } } } };
function E() {
}
var N = v(function(t2) {
  return import_react50.default.createElement("svg", Object.assign({ viewBox: "0 0 1024 1024", version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em" }, t2), import_react50.default.createElement("path", { d: "M571.733333 512l268.8-268.8c17.066667-17.066667 17.066667-42.666667 0-59.733333-17.066667-17.066667-42.666667-17.066667-59.733333 0L512 452.266667 243.2 183.466667c-17.066667-17.066667-42.666667-17.066667-59.733333 0-17.066667 17.066667-17.066667 42.666667 0 59.733333L452.266667 512 183.466667 780.8c-17.066667 17.066667-17.066667 42.666667 0 59.733333 8.533333 8.533333 19.2 12.8 29.866666 12.8s21.333333-4.266667 29.866667-12.8L512 571.733333l268.8 268.8c8.533333 8.533333 19.2 12.8 29.866667 12.8s21.333333-4.266667 29.866666-12.8c17.066667-17.066667 17.066667-42.666667 0-59.733333L571.733333 512z", "p-id": "4730" }));
});
var w = (t2) => {
  var l2, s2;
  const [p2, v2] = (0, import_react50.useState)(false), y2 = (0, import_react50.useRef)(null), { isOpen: h2, width: g2, duration: E2, customCrossIcon: w2, customIcon: O2, side: x2, animate: C2 } = t2;
  ...
  function k(e2) {
    let t3 = b2[e2] ? function(e3) {
      return e3("string" != typeof g2 ? `${g2}px` : g2);
    }(b2[e2]) : {};
    return t3 = Object.assign({}, t3), t3;
  }
  const I = () => {
    const e2 = (e3, t3) => {
      null == e3 || e3.classList[p2 ? "add" : "remove"](t3);
    };
    t2.bodyClassName && e2(document.querySelector("body"), t2.bodyClassName), t2.htmlClassName && e2(document.querySelector("html"), t2.htmlClassName);
  }, K = w2 || import_react50.default.createElement(N, { className: "close-icon" }), V = t2.children ? import_react50.Children.map(t2.children, (e2) => (0, import_react50.cloneElement)(e2, { onClick: t2.onClick, selectedKey: t2.selectedKey, level: 1 })) : null, L = null !== (s2 = null === (l2 = null == f ? void 0 : f[C2]) || void 0 === l2 ? void 0 : l2[x2]) && void 0 !== s2 ? s2 : {};
  return import_react50.default.createElement(import_react50.default.Fragment, null, !t2.noOverlay && import_react50.default.createElement(AnimatePresence, null, p2 && import_react50.default.createElement(motion.div, { className: `overlay ${t2.overlayClassName}`, style: k("overlay"), onClick: () => {
    j2();
  }, initial: "closed", animate: "open", exit: "closed", variants: { open: { opacity: 1 }, closed: { opacity: 0 } } })), import_react50.default.createElement(AnimatePresence, { onExitComplete: () => {
    p2 || (I(), t2.onClose());
  } }, p2 && import_react50.default.createElement(motion.div, { className: (0, import_classnames.default)("menu-wrap", t2.className), ref: y2, style: Object.assign(Object.assign({}, k("menuWrap")), null == L ? void 0 : L.style), transition: { duration: E2, ease: "easeInOut" }, initial: "end", animate: "start", exit: "end", variants: { start: null == L ? void 0 : L.start, end: null == L ? void 0 : L.end }, onAnimationComplete: () => {
    p2 && (I(), t2.onOpen());
  } }, import_react50.default.createElement("div", { className: "head" }, (0, import_react50.isValidElement)(O2) && (0, import_react50.cloneElement)(O2, { className: (0, import_classnames.default)("logo", O2.props.className) }), import_react50.default.createElement("div", { className: "close", onClick: j2 }, K)), import_react50.default.createElement("div", { className: "menu" }, V))));
};
w.defaultProps = { width: 300, noOverlay: false, overlayClassName: "", onOpen: E, onClose: E, onClick: E, side: "right", animate: "slide" };
var O = (t2) => {
  return import_react50.default.createElement("div", { className: (0, import_classnames.default)("bm-item", { "bm-item-selected": t2.itemKey === t2.selectedKey }), onClick: (e2) => {
    const n3 = { itemKey: t2.itemKey, domEvent: e2, text: t2.text };
    t2.onClick(n3);
  } }, (n2 = t2.icon) || t2.level > 1 ? import_react50.default.createElement("i", { className: "bm-item-icon" }, n2) : null, import_react50.default.createElement("span", { className: "item-text" }, t2.text));
  var n2;
};
O.defaultProps = { onClick: E, icon: null, level: 1 };
var x = w;
var C = g;
var j = O;
export {
